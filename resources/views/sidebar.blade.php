<div class="wrapper">
    ...
    <ul class="list-unstyled components">
        ...
        <script>
            $(document).ready(function() {
                $('#sendDataBtn').click(function() {
                    $.ajax({
                        url: '{{ route("send.data.to.arduino") }}',
                        method: 'POST',
        ...
        <li class="{{ request()->is('schedule') ? 'active' : '' }}">
            <a href="{{ route('schedule.index') }}" class="mobile-icon">
        ...
        <li class="{{ request()->is('schedule-List') ? 'active' : '' }}">
            <a href="{{ route('schedule.filter') }}" class="mobile-icon">
