    ...
    <div class="card-body">
        ...
        <div class="card border-0">
            ...
            <form id="powerForm" action="{{ route('update-ac', ['id' => 1]) }}" method="post">
                ...
                <button type="button" class="btn {{ $acState === 'Active' ? 'btn-success' : 'btn-danger' }} btn-lg rounded-circle" onclick="confirmPowerAction()" >
        ...
        <div class="card border-0">
            ...
            <form id="lightsForm" action="{{ route('update-lights', ['id' => 1]) }}" method="post">
                ...
                <button type="button" class="btn {{ $lightsState === 'Active' ? 'btn-success' : 'btn-danger' }} btn-lg rounded-circle" onclick="confirmLightsAction()">
